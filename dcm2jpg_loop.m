...
addpath('C:\Users\cober\Documents\MATLAB_DICOM_TO_JPG\export_fig-master');
...
for k = 1:length(filePattern_i) %recorre todas las imagenes
  ...
  %save output image jpg format 
  %deleting .dcm in basefilename and change to .jpg
